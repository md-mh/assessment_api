...
candidateExamsRouter.get(
  "/attempts/:attemptId",
  candidateExamsController.getAttempt,
);

candidateExamsRouter.get(
  "/attempts/:attemptId/questions/:questionIndex",
  candidateExamsController.getQuestion,
);

candidateExamsRouter.post(
  "/attempts/:attemptId/answers",
  validateBody(saveAnswerBodySchema),
  candidateExamsController.postAnswer,
);

candidateExamsRouter.post(
  "/attempts/:attemptId/complete",
  candidateExamsController.complete,
);

candidateExamsRouter.post(
  "/attempts/:attemptId/timeout",
  candidateExamsController.timeout,
);
