...
import {
  ...
  listTestsForEmployer,
  removeQuestion,
} from "./online-tests.service.js";
import {
  countExamQuestionsForTest,
  getExamQuestionMeta,
  getOnlineTestById,
...
export const onlineTestsController = {
  ...
  saveQuestion: asyncHandler(async (req: Request, res: Response) => {
    const employerId = req.user!.id;
    ...
    const result = addOrUpdateQuestion(
      employerId,
      testId,
      questionPayload,
      sortOrder,
